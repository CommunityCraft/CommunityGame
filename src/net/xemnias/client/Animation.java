...
public class Animation implements Renderable {
	...
	private org.newdawn.slick.SpriteSheet spriteSheet = null;
	 ...
	 */
	public Animation(org.newdawn.slick.SpriteSheet frames, int duration) {
	 ...
	 */
	public Animation(org.newdawn.slick.SpriteSheet frames, int x1, int y1, int x2, int y2, boolean horizontalScan, int duration, boolean autoUpdate) {
		this.autoUpdate = autoUpdate;
	 ...
	 * @param duration The duration each frame should be displayed for
	 */
	public Animation(org.newdawn.slick.SpriteSheet ss, int[] frames, int[] duration){
		spriteSheet = ss;
	    int x = -1;
	    int y = -1;
